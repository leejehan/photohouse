...
<div id="wrap">
	<div id="diarytop">
		<div id="today">
			<center>
				<p id="todayfont">${month}월${date }일<br>
					<c:if test="${sday==1 }">
...
<form action="WillBeServlet?command=updatediaryform&year=${year}&month=${month}&date=${date}" method="post">
<div id="diarycontent">
	<textarea id="contentarea" cols="73" rows="25" name="content">${diary.diary_content }</textarea>
</div>
<div id="diarybutton">

	<div><input type="submit" value="수정완료" id="updatediary"></div>
</div>
	</form>
	</center>
</div>
