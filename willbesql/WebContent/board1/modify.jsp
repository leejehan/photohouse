...
<style>
	*{margin:0px; padding:0px;font-family:Malgun;}
	...
	#textBox{
		...
		width:700px;
		min-height:400px;
		background-image: url(textline.gif);
	}
	#regitButton{
		float:right;
	...
	#listButton:focus, #listButton:hover{
		box-shadow: 0 3px 6px rgba(0, 0, 0, 0.6);	
	}
...
<div id="boardHeader">
	<div id="boardHeader_title">함께 해요!</div>
</div>
<div id="boardBody">
	<div id="boardBody_form">
		<form name="modify" action="modify_output.sw" method="post"
		enctype="multipart/form-data" onsubmit="return Check()">
		<input type="hidden" name="num" value="${modi.board_num }">
			<table id="formTable">
				<tr><td class="titleName">작성자</td>
				<td><input type="text" id="writerId" class="inputType" name="id" value="${modi.member_id }" readonly="readonly"/>
				</td></tr>

				<tr><td class="titleName">파일첨부</td>
				<td><input type="file" id="file" name="userFile" value="${modi.board_file}"></td>
				</tr>

				<tr><td class="titleName">제목</td>
				<td><input type="text" class="inputType" class="inputType" maxlength="25" name="title"  value="${modi.board_title }">
				</td></tr>

				<tr><td colspan="2" class="titleName">글 쓰기</td></tr>
				<tr id="textTr"><td colspan="2"><textarea id="textBox" class="inputType" wrap="virtual" name="contents">${modi.board_contents }   ${modi.board_file}</textarea>
				</td></tr>

				<tr><td colspan="2">
				<input type="submit" id="regitButton" value="수정">
				<div id="listButton"><a href='listboard.sw'>목록</a></div></td></tr>
			</table>			
		</form>		
	</div>
</div>
