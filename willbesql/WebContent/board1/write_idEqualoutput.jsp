...
<div id="boardBody">
	...
	<div id="boardBody_body">
		...
		<div id="file" class="content"><a href="file_down.sw?num=${content_view.board_num}">${content_view.board_file}</a></div>
		<div id="clear"></div>
		<div id="contents"><pre>${content_view.board_contents}</pre></div>
		<div id="clear"></div>
	</div>
	<div id="boardBody_body_foot">
		<div id="recommend"><a href="like.sw?num=${content_view.board_num}"><img src="imgs/likeHeartButton.png" id="heartbutton"></a></div>
	</div>
</div>
<div id="boardFoot">
	<div id="boardFoot_header">
		<div id="reply" class="content">추천 ${content_view.board_like}&nbsp;</div>
			...
			<table id="relpyTable">
				<c:forEach items="${replyDto}" var="replyDto" begin="0" end="${replySize }">		  		
					<tr>
						...
						<td id="relpyButton">
						<a href="replyDelete.sw?replyNum=${replyDto.reply_num }&num=${replyDto.board_num }">
	...
	<div id="boardFoot_foot">
		<form action="reply_input.sw" method="post">		
		<div id="replyInput">
		...
		<div id="menuList">		
			<div id="menuList_1" class="menuList">
				<a href='listboard.sw'>목록</a>
			</div>
			<div id="menuList_2" class="menuList">
				<a href='write.sw'>글쓰기</a>
			</div>
			<div id="menuList_3" class="menuList">				
				<a href="delete_pass.sw?num=${content_view.board_num}">삭제</a>
			</div>	
			<div id="menuList_4" class="menuList">				
				<a href="modify_pass.sw?num=${content_view.board_num}">수정</a>
			</div>
		</div>
	</div>
</div>
...
function replyPost(){
	...
	var url="reply_input.sw?id="+id+"&replyContents="+replyContents+"&num="+boardNum;
	location.href=url;
}
</script>
</body>
