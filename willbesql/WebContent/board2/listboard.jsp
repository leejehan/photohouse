...
<!-- 타이틀메뉴 틀 끝 -->
		...
		<div id="listBody_body">
			<center>
				...
				<%
					for (int i = fp; i <= lp; i++) {
				%>
				<a href="listboard.qt?currentPage=<%=i%>&fp=<%=fp%>&lp=<%=lp%>">
					<%
						out.println(i);
					%>
				</a>
	...
	<script>
		...
		function pageDecrease() {
			...
			var url = "listboard.qt?&currentPage="	+ DecreasePage + "&fp=" + String(fp) + "&lp=" + String(lp);
			location.href = url;
		}
		...
		function pageIncrease() {
			...
			var url = "listboard.qt?&currentPage="	+ IncreasePage + "&fp=" + String(fp) + "&lp=" + String(lp);
			location.href = url;
		}
