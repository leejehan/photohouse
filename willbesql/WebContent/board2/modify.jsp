...
<div id="boardBody">
	<div id="boardBody_form">
		<form name="modify" action="modify_output.qt" method="post"
		enctype="multipart/form-data" onsubmit="return Check()">
			...
			<input type="hidden" name="num" value="${modi.board_num }">
				...
				<tr id="textTr"><td colspan="2"><textarea id="textBox" class="inputType" wrap="virtual" name="contents">${modi.board_contents }</textarea>
				</td></tr>

				<tr><td colspan="2">
				<input type="submit" id="regitButton" value="수정">
				<div id="listButton"><a href='listboard.qt'>목록</a></div></td></tr>
			</table>			
		</form>		
	</div>
</div>
