...
public class boardDTO {
	...
	public boardDTO(int num, String title, String id, Timestamp date, int readcount) {
		this.board_num=num;
	...
	public boardDTO(String num, String id, String title, Timestamp date, String contents, int readcount, String file) {
